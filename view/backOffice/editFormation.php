...
if( isset($_POST['idformation']) && isset($_POST['titre']) && isset($_POST['description']) && isset($_POST['adresse']) && isset($_POST['date_debut']) && isset($_POST['date_fin']) && isset($_POST['place']) && isset($_POST['prix']) && isset($_POST['image'])){
    ...
    $formationC->updateformation($_POST['idformation'],$formation);
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Modifier un formation</h4>
                    <form id="myForm" class="forms-sample" action="editformation.php" method="post">
                    <input hidden type="text" class="form-control" name="idformation" value="<?php echo $formation['idformation']; ?>">
                      <div class="form-group">
                        <label for="titre">Titre</label>
                        <input type="text" class="form-control" id="titre" name="titre" placeholder="Titre" value="<?php echo $formation['titre']; ?>">
                        <span id="errorTitre"></span>
                      </div>
                      <div class="form-group">
                        <label for="Description">Descrition</label>
                        <textarea class="form-control" id="description" name="description" rows="4"><?php echo $formation['description']; ?></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="date_debut" name="date_debut" value="<?php echo $formation['date_debut']; ?>">
                        <span id="errorDateDebut"></span>
                      </div>
                      <div class="form-group">
                        <label for="date_fin">Date Fin</label>
                        <input type="date" class="form-control" id="date_fin" name="date_fin" value="<?php echo $formation['date_fin']; ?>">
                        <span id="errorDateFin"></span>
                      </div>
                      <div class="form-group">
                        <label for="place">Nombre de place</label>
                        <input type="text" class="form-control" id="place" name="place" placeholder="Nombre de place" value="<?php echo $formation['place']; ?>">
                        <span id="errorNbrPlace"></span>
                      </div>
                      <div class="form-group">
                        <label for="prix">Prix</label>
                        <input type="text" class="form-control" id="prix" name="prix" placeholder="Prix" value="<?php echo $formation['prix']; ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                          <input type="text" id="image" name="image" class="form-control file-upload-info" placeholder="Upload Image" value="<?php echo $formation['image']; ?>">
