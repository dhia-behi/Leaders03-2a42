<?php 
    ...
    if(isset($_POST['name'])){
        ...
        $reclamation1 =  new reclamation($_POST['name'],$_POST['email'],$_POST['sujet'],$_POST['message']);
        $r=new reclamationC();
        
        $r->addreclamation($reclamation1);
						...
						<div class="banner-content col-lg-12">
                            ...
                            <div class="col-lg-12">
								...
								<div class="col-lg-12">
									<div class="form-group">
									<label for=""></label>
									<input type="text" placeholder="Your subject" name="sujet" class="form-control" id="sujet">
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
									<label for=""></label>
										<textarea name="message" class="form-control" cols="20" rows="5" id="message"></textarea>
									</div>
								</div>
								<div class="col-lg-12">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
		...
		<script>
							...
							myForm.addEventListener('submit', function(e){
								...
								let myRegex = /^[a-zA-Z\s]+$/; // expretion reguliere
