						...
						<div class="banner-content col-lg-12">
                            ...
                            <div class="col-lg-12">
									<div class="form-group">
										<label for=""></label>
									<input value="<?= $currentreclamation['name']?>" type="text" placeholder="Your Name" name="name" class="form-control" id="name">
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
									<label for=""></label>
									<input value="<?= $currentreclamation['email']?>" type="text" placeholder="Your E-mail" name="email" class="form-control" id="email">
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
									<label for=""></label>
									<input value="<?= $currentreclamation['sujet']?>" type="text" placeholder="Your subject" name="sujet" class="form-control" id="sujet">
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
