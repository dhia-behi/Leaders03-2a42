...
$evenements = $actC->joinformation($_GET['id']);
        ...
        <div class="container-fluid packages py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">formation : <?php echo $formation['titre']; ?></h5>
                ...
                <?php 
                    ...
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="../images/<?php echo $evenements['image']; ?>" class="img-fluid w-100 rounded-top" alt="Image">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt me-2"></i><?php echo $evenements['heure_debut']; ?> | <?php echo $evenements['heure_fin']; ?></small>
                                <small class="flex-fill text-center py-2"><i class="fa fa-user me-2"></i><?php echo $evenements['place']; ?> Person</small>
                            </div>
                        </div>
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0"><?php echo $evenements['titre']; ?></h5>
                                <div class="mb-3">
                                ...
                                <p class="mb-4"><?php echo $evenements['description']; ?></p>
                            </div>
