...
$var=$reclamationC->allreclamation();
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="http://localhost/reclamation/view/afficher.php">Back to interface</a>
                            <a class="nav-link menu-link" href="#sidebarDashboards1" data-bs-toggle="collapse" role="button"
                               aria-expanded="false" aria-controls="sidebarDashboards1">
                                <i class="ri-notification-2-line"></i> <span data-key="t-dashboards">Reclamation</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarDashboards1">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="afficherab.php" class="nav-link" data-key="t-crm">List of Reclamation</a>
                                    </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Reclamation</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">List of Reclamation</h4>
                                                ...
                                                <table class="table table-borderless align-middle table-nowrap mb-0">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th scope="col"><a href="afficherad.php?trier=fullname"><i class="ri-sort-desc"></i> </a>name</th>
                                                            <th scope="col"><a href="afficherad.php?trier=username"><i class="ri-sort-desc"></i> </a>email</th>
                                                            <th scope="col"><a href="afficherad.php?trier=email"><i class="ri-sort-desc"></i> </a>sujet</th>
                                                            <th scope="col"><a href="afficherad.php?trier=password"><i class="ri-sort-desc"></i> </a>message</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
													<?php
