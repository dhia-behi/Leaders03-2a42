...
$currentreclamation = $reclamationC->findreclamation($id);
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarDashboards1">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="afficherab.php" class="nav-link" data-key="t-crm">Display Reclamation</a>
                                    </li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Edit Reclamation</h4>
                                    ...
                                    <div class="col-xxl-3 col-md-6 container">
										<div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <label for=""></label>
                                                    <input value="<?= $currentreclamation['name']?>" type="text" name="name" class="form-control">  
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                            <label for=""></label>
                                                    <input value="<?= $currentreclamation['email']?>" type="text" name="email" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                            <label for=""></label>
                                                     <input value="<?= $currentreclamation['sujet']?>" type="text" name="sujet" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                            <label for=""></label>
                                                <textarea name="message" class="form-control" cols="20" rows="5" id="message"><?= $currentreclamation['message']?></textarea>   
                                            </div>
                                            </div>
                                            <br><br>
                                        </div>    
